<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AMasterPage.master" AutoEventWireup="true" CodeFile="Change Password.aspx.cs" Inherits="Admin_Change_Password" %>
                           ...
                           <br>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                   ...
                                   <span class="input-group-addon"><i class="fa fa-key"></i></span> <asp:TextBox ID="txtOldPass" runat="server" class="form-control" TextMode="Password" placeholder="Enter Old Password"></asp:TextBox>
                                </div>
                                    </div>
                            </div>
                            <br>
