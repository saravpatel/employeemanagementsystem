<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Employee_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <form id="Form1" name="f1" runat="server">
        ...
        <br />
            ...
            <div style="margin: auto; border-style: solid; border-color: #000000; width: 30%; height: 250px; float: left; background-repeat: repeat; background-image: url('http://localhost:49396/backgroung.jpg'); font-family: 'Arial Rounded MT Bold';">
        <h1 style="font-family: Georgia, 'Times New Roman', Times, serif; font-weight: bold; color: #FFFFFF; text-decoration: underline;">All News</h1>        
                <asp:Panel ID="Panel1" runat="server">
                     <marquee direction="up" scrolldelay="4" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start();">
